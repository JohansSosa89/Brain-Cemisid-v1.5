...
ViewFinder::ViewFinder(QMainWindow * mainWindow){
    ...
    canvas = NULL;
    zoomIn = new QAction(QIcon("icons/zoomin.png"),QMainWindow::tr("&Acercar"),dialogCanvas);
    ...
    dialogCanvas->setWindowTitle("Visor Gráfico");
    dialogCanvas->setWindowIcon(QPixmap("icons/seeNet.png"));
}
