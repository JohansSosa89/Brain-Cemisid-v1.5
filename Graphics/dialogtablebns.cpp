...
DialogTableBNS::DialogTableBNS(QWidget *parent, const NeuralNetwork *neuralSenses, const SizeNet *sizeNet) : QDialog(parent), ui(new Ui::DialogTableBNS){
        ui->setupUi(this);
...
void DialogTableBNS::fillTable(const NeuralNetwork *neuralSenses, QTableWidget *&table){
    ...
    table->resizeColumnToContents(RATIO);
